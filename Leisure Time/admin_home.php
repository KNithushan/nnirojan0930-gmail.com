...
<body>
	...
	<div id="main">
		...
		<ul>
			...
			<li><a href="staff_reg_form.php">Staff Details </li><br>
			<li><a href="member.php">member update</a></li><br>
			<li><a href="member_reg_form.php">member Details </a></li><br>
			<li><a href="feed_back_form.php">Feedback</a></li>	
		</ul>
